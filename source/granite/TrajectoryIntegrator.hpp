...
private:
    ...
    TextureInfo _additional_textures[MAX_ADDITIONAL_VOLUMES];
...
protected:
    /**
     * @brief Access the particle positions on the gpu after a simulation run
     *        Used to speed up CauchyGreenIntegrator.
     */
    float * lastDevicePointer() { return _particles_device.front(); }
...
protected:
    /**
     * @brief Construct a new Trajectory Integrator object
     *        This constructor is for specialized integrators which use an instance of this
     *        object internally (e.g. CauchyGreenIntegrator). These require to initialize
     *        windfield data, before start_particles are generated.
     *
     * @param settings
     * @param loader
     */
    ...
    {
        verifySettings();
        initializeWindfields();
        initializeTopography();
        initializeAdditionalVolumes();
    }
...
public:
    ...
    TrajectoryIntegrator(              //
        ...
        : TrajectoryIntegrator(settings, loader)
    {
        initSet(set);
    }
...
private:
    ...
    template <typename VEC_T> void loadLiftData(SimulationData<VEC_T> & data);

    /**
     * @brief Does an initial selection and buffers first windfields to the gpu.
     */
    void initializeWindfields();
    ...
    // Initializes textures for additional volumes.
    void initializeAdditionalVolumes();
